...
class TestPersonService(unittest.TestCase):
    ...
    def test_add_person(self):
        ...
        self.assertTrue(Person(5, 'Vlad Bogdan', '0745 080 454') in self.pers_repo)
        ...
        self.assertEqual(len(self.pers_repo), 3)
    ...
    def test_delete_person_by_id(self):
        ...
        self.assertEqual(len(self.pers_repo), 2)
        self.pers_service.delete_person_by_id(5)
        self.assertEqual(len(self.pers_repo), 1)
        self.pers_service.delete_person_by_id('1')
        self.assertEqual(len(self.pers_repo), 0)
    ...
    def test_update_person_phone_number(self):
        ...
        person1 = self.pers_service.find_person_by_id(5)
    ...
    def test_find_person_by_id(self):
        ...
        person_found = self.pers_service.find_person_by_id(5)
        self.assertIsInstance(person_found, Person)
        person_found = self.pers_service.find_person_by_id('1')
        self.assertIsInstance(person_found, Person)
        self.assertIsNone(self.pers_service.find_person_by_id(2))
    ...
    def test_fill_repo_with_random_persons(self):
        ...
        self.assertEqual(len(self.pers_repo), 20)
