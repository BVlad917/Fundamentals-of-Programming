...
class TestActivity(unittest.TestCase):
    ...
    def test_json_dump_and_load(self):
        json_act1_dumped = self.activity_1.json_dump()
        test_dumped_obj_against = {'Activity': {'id': 1, 'start': '17/05/2021 17:30', 'end': '17/05/2021 19:00',
                                     'description': 'birthday', 'persons': [1, 2, 3]}}
        self.assertEqual(json_act1_dumped, test_dumped_obj_against)

        json_act1_loaded = Activity.json_load(test_dumped_obj_against)
        self.assertEqual(json_act1_loaded, self.activity_1)