...
class TestPerson(unittest.TestCase):
    ...
    def test_json_dump_and_load(self):
        json_pers1_dumped = self.person_1.json_dump()
        test_dumped_obj_against = {'Person': {'id': 1, 'name': 'Vlad Bogdan', 'phone': '0745000111'}}
        self.assertEqual(json_pers1_dumped, test_dumped_obj_against)

        json_pers1_loaded = Person.json_load(test_dumped_obj_against)
        self.assertEqual(json_pers1_loaded, self.person_1)
